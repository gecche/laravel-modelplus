...
use Gecche\ModelPlus\Contracts\DBHelpers as DBHelpersContract;

class DBHelpersMysqlDriver implements DBHelpersContract
{
    /*
    ...
    public function __construct($connectionName,Connection $connection, CacheManager $cacheManager)
    {
        $this->connectionName = $connectionName;
        $this->connection = $connection;
        $this->cache = $cacheManager;
        $this->hasCache = config('modelplus.dbhelpers.cache');
    }
